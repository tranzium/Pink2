...
void WalletModel::subscribeToCoreSignals()
{
    ...
    coreSignalConnections.push_back(
        wallet->NotifyAddressBookChanged.connect(std::bind(NotifyAddressBookChanged, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4, std::placeholders::_5)));
    coreSignalConnections.push_back(
        wallet->NotifyAddressBookStakeChanged.connect(std::bind(NotifyAddressBookStakeChanged, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4, std::placeholders::_5)));
    coreSignalConnections.push_back(
